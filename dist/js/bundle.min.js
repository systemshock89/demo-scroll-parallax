...
'use strict';
const lazyLoadInstance = new vanilla_lazyload__WEBPACK_IMPORTED_MODULE_0__({
  elements_selector: ".lazy"
});
document.addEventListener('DOMContentLoaded', () => {
  gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.registerPlugin(gsap_ScrollTrigger_js__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger, ScrollSmoother);
  if (!gsap_ScrollTrigger_js__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger.isTouch) {
    // Smooth scroll
    ...
    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.fromTo('.layer__header', {
      opacity: 1
    }, {
      opacity: 0,
      scrollTrigger: {
        trigger: '.layer__header',
        // эл-т триггера (тот эд-т, который появляется в поле зрения и будут происходить следующие события:)
        start: '-200',
        // начинаем анимацию, когда эл-т находится в центре
        end: '100',
        // где эл-т находится, когда совершили действие
        scrub: true // возвращаем предыдущее значение (когда листаем обратно, то эл-т снова появится)
      }
    });

    gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.fromTo('.main-article__content', {
      opacity: 0
    }, {
      opacity: 1,
      scrollTrigger: {
        trigger: '.main-article__content',
        // эл-т триггера (тот эд-т, который появляется в поле зрения и будут происходить следующие события:)
        start: '-850',
        // начинаем анимацию, когда эл-т находится в центре
        end: '-300',
